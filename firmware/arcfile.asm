...
l81: # 
	...
	add	r4
		...
		// flags 62, 4a
						...
						// Destination is a variable with offset 0, 143
		// Real offset of type is 143, isauto 0
						// (prepobj r0)
 						// reg r3 - no need to prep
	...
	mr	r1
		...
		// flags 4a, 4a
						// (a/p assign)
						// Destination is a register...
						// Destination is a variable with offset 0, 97
		// Real offset of type is 97, isauto 0
						// (prepobj r0)
 						// reg r3 - no need to prep
						// (obj to tmp) flags 4a type 101
						// matchobj comparing flags 4a with 4a
